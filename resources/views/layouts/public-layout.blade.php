...
<div id="page" class="s-pagewrap">
    ...
    <header id="masthead" class="s-header">
        ...
        <div class="s-header__branding">
            <p class="site-title">
                <a href="/" rel="home">Pamir Culture</a>
            </p>
        </div>
                ...
                <ul class="s-header__nav">
                    ...
                    <li class="has-children">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="category.html">Performing Arts</a></li>
                            <li><a href="category.html">Language</a></li>
                            <li><a href="category.html">Religion</a></li>
                            <li><a href="category.html">Food</a></li>
                            <li><a href="category.html">Traditions & Holidays</a></li>
    ...
    code {
        ...
        <script src="js/main.js"></script></div></div>
</body>
</html>
